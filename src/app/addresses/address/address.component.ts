...
export class AddressComponent implements OnInit {
  ...
  buildForm() {
    ...
    this.addressForm = this.fb.group({
      addressId: [this.address.addressId || '00000000-0000-0000-0000-000000000000', [Validators.required]],
      entityId: [this.address.entityId || '00000000-0000-0000-0000-000000000000', [Validators.required]],
      entityType: [this.address.entityType.entityTypeName || '00000000-0000-0000-0000-000000000000', [Validators.required]],
      addressType: [this.address.addressType.addressTypeName || '00000000-0000-0000-0000-000000000000', [Validators.required]],
      ...
      addressPostalCode: [this.address.addressPostalCode || '', [Validators.required]],
